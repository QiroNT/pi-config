...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"The host machine can run programs that are not installed. If a command is not available, retry with a comma prefix like ', nvcc'. This is not available in the VM.",
		],
